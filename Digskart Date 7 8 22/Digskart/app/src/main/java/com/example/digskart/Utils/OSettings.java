...
public class OSettings {
    ...
    public OSettings(Context mActivity) {
...
//    }
//
// public static void putStringContext(String key, String value, Context context) {
//        SharedPreferences prefs = context.getSharedPreferences(AppSettings.PREFS_MAIN_FILE, Context.MODE_PRIVATE);
//        SharedPreferences.Editor editor = prefs.edit();
//        editor.putString(key, value);
//        editor.commit();
//    }
